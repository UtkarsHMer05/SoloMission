...
class GameScene: SKScene , SKPhysicsContactDelegate{
    ...
    let bulletSound = SKAction.playSoundFileNamed("soundEffect.mp3", waitForCompletion: false)
    ...
    enum gameState{
          ...
          case afterGame  //when the game state  is in the end of  the game
      }
    ...
    func addScore(){
        ...
        if gameScore == 10 || gameScore == 25 || gameScore == 40 || gameScore == 50 || gameScore == 75{
                startNewLevel()
            }
